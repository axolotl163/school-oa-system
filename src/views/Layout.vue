    ...
    <aside class="sidebar" :class="{ 'sidebar-open': sidebarOpen }">
      ...
      >
        <el-menu-item index="/">
          ...
          <template v-slot:title><span>首页</span></template>
        </el-menu-item>
        
        <el-sub-menu v-if="canAccess(['管理员', '教师'])" index="student-management">
          <template #title>
            <el-icon><User /></el-icon>
            <span>学生管理</span>
          </template>
          <el-menu-item v-if="canAccess(['管理员'])" index="/student">学生信息</el-menu-item>
          <el-menu-item v-if="canAccess(['管理员', '教师'])" index="/score">成绩管理</el-menu-item>
        </el-sub-menu>
        
        <el-sub-menu v-if="canAccess(['管理员'])" index="teaching-management">
          <template #title>
        ...
        <el-sub-menu v-if="canAccess(['管理员', '教师'])" index="admin-management">
          <template #title>
        ...
        <el-sub-menu v-if="canAccess(['管理员'])" index="system-management">
          <template #title>
        ...
        <el-menu-item index="/profile">
          ...
          <template v-slot:title><span>个人中心</span></template>
        </el-menu-item>
        <el-menu-item @click="handleLogout">
          <el-icon><SwitchButton /></el-icon>
          <template v-slot:title><span>退出登录</span></template>
        </el-menu-item>
      </el-menu>
    </aside>
    ...
    <div class="main-content">
      <header class="header">
        <div class="header-left">
          <el-button v-if="isMobile" text @click="sidebarOpen = !sidebarOpen">
...
import { House, User, UserFilled, SwitchButton, Reading, Setting, Tools, Fold } from "@element-plus/icons-vue";
